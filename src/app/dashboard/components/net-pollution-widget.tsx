    ...
    <Card className="lg:col-span-2">
      <CardHeader>
        <CardTitle className="flex items-center justify-between text-base font-medium">
          <span>Net Carbon Balance</span>
          <Bolt className="h-5 w-5 text-muted-foreground" />
        </CardTitle>
        <div className="flex items-baseline gap-2">
          <p className="text-4xl font-bold text-destructive">{latestValue}k tons</p>
        </div>
        <CardDescription>Balance of Emissions & Absorption for Dec 2024</CardDescription>
      </CardHeader>
